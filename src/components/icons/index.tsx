...
//para pegar mais icones acessar 
// https://heroicons.com/
...
export const IconeSol =(tamanho=6)=>(
  <svg xmlns="http://www.w3.org/2000/svg" className={`h-${tamanho} w-${tamanho}`} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
